import type {
	...
	QueryAnswer,
	OfflineStatusAnswer,
} from "~/components/status/interfaces";

export const javaPart: JavaStatusAnswer = {
	online: true,
	address: {
		host: "mc.hypixel.net",
		port: 25565,
	...
	motd: {
		...
		plain: "                Hypixel Network [1.8-1.19]\n    10th ANNIVERSARY - EASTER EVENT § SALE",
		html: "<p>                <span style='color:rgb(85, 255, 85);text-shadow:0 0 1px rgb(21, 63, 21)'>Hypixel Network </span><span style='color:rgb(255, 85, 85);text-shadow:0 0 1px rgb(63, 21, 21)'>[1.8-1.19]\n    </span><span style='color:rgb(255, 170, 0);text-shadow:0 0 1px rgb(42, 42, 0)'><b>10th ANNIVERSARY </span></b><span style='color:rgb(170, 170, 170);text-shadow:0 0 1px rgb(42, 42, 42)'>- </span><span style='color:rgb(85, 255, 255);text-shadow:0 0 1px rgb(21, 63, 63)'><b>EASTER EVENT </span></b><span style='color:rgb(170, 170, 170);text-shadow:0 0 1px rgb(42, 42, 42)'>§ </span><span style='color:rgb(255, 85, 85);text-shadow:0 0 1px rgb(63, 21, 21)'><b>SALE</span></b></p>",
		ansi: "\x1b[0m                \x1b[0m\x1b[38;2;85;255;85mHypixel Network \x1b[0m\x1b[38;2;255;85;85m[1.8-1.19]\n    \x1b[0m\x1b[38;2;255;170;0m\x1b[1m10th ANNIVERSARY \x1b[0m\x1b[38;2;170;170;170m- \x1b[0m\x1b[38;2;85;255;255m\x1b[1mEASTER EVENT \x1b[0m\x1b[38;2;170;170;170m§ \x1b[0m\x1b[38;2;255;85;85m\x1b[1mSALE\x1b[0m",
	},
	version: {
		name: {
			raw: "Purpur 1.19.4",
			plain: "Purpur 1.19.4",
			html: "<p>Purpur 1.19.4</p>",
			ansi: "\u001b[0mPurpur 1.19.4\u001b[0m",
		},
		protocol: 762,
	},
	players: {
		...
		list: [
			// can be undefined
			{
				name: {
					raw: "Perchun_Pak",
					plain: "Perchun_Pak",
					html: "<p>Perchun_Pak</p>",
					ansi: "\u001b[0m\u001b[0mPerchun_Pak\u001b[0m",
				},
				uuid: "0b3717c4-f45d-47c8-b8e2-3d9ff6f93a89",
			},
			{
				name: {
					raw: "Salko",
				...
				uuid: "021ee2f3-7cc2-41d1-a517-c3166fe333c2",
			},
			{
				name: {
					raw: "WiseMysticalTree",
					plain: "WiseMysticalTree",
					html: "<p>WiseMysticalTree</p>",
					ansi: "\u001b[0m\u001b[0mWiseMysticalTree\u001b[0m",
				},
				uuid: "e6cfb84b-c9b8-4328-b20e-727407df20aa",
			},
			{
				name: {
					raw: "Mister_Fix",
			...
			},
			{
				name: {
					raw: "EinfxchLisa",
					plain: "EinfxchLisa",
					html: "<p>EinfxchLisa</p>",
					ansi: "\u001b[0m\u001b[0mEinfxchLisa\u001b[0m",
				},
				uuid: "e80af961-dc42-4ef1-af66-73d667d941a0",
			},
			{
				name: {
					raw: "pawjobs",
					plain: "pawjobs",
					html: "<p>pawjobs</p>",
					ansi: "\u001b[0m\u001b[0mpawjobs\u001b[0m",
				},
				uuid: "e0fe0cc9-d156-4425-adad-9782cb05db6a",
			},
			{
				name: {
					raw: "EinfxchLukas",
					plain: "EinfxchLukas",
					html: "<p>EinfxchLukas</p>",
					ansi: "\u001b[0m\u001b[0mEinfxchLukas\u001b[0m",
				},
				uuid: "ce1fc54b-fc1d-4579-af2e-0d6e18f0cea7",
			},
			{
				name: {
					raw: "RubbaBoy",
					plain: "RubbaBoy",
					html: "<p>RubbaBoy</p>",
					ansi: "\u001b[0m\u001b[0mRubbaBoy\u001b[0m",
				},
				uuid: "946dba0a-1eee-489a-ab6d-516927fb2df7",
			},
			{
				name: {
					raw: "ScoutingForSued",
					plain: "ScoutingForSued",
					html: "<p>ScoutingForSued</p>",
					ansi: "\u001b[0m\u001b[0mScoutingForSued\u001b[0m",
				},
				uuid: "c5eb8d11-ac67-49d0-99a8-18b5901811dc",
			},
			{
				name: {
					raw: "8blockluca",
					plain: "8blockluca",
					html: "<p>8blockluca</p>",
					ansi: "\u001b[0m\u001b[0m8blockluca\u001b[0m",
				},
				uuid: "c6c8473d-d184-4f74-bab2-8688eb0c4578",
			},
			{
				name: {
					raw: "DarkEyeDragon",
					plain: "DarkEyeDragon",
					html: "<p>DarkEyeDragon</p>",
					ansi: "\u001b[0m\u001b[0mDarkEyeDragon\u001b[0m",
				},
				uuid: "f73aa17d-166f-4535-92bd-49eda5a27b31",
			},
		],
	},
	...
	internal: {
		cached_at: 1673774293240,
		cache_ends_at: 1673774353240,
	},
	additional: {
...
export const bedrockPart: BedrockStatusAnswer = {
	online: true,
	address: {
		host: "mc.hypixel.net",
		port: 19132,
	...
	version: {
		name: {
			...
			plain: "Requires MC 1.8 / 1.19",
			html: "<p>Requires MC 1.8 / 1.19</p>",
			ansi: "\x1b[0mRequires MC 1.8 / 1.19\x1b[0m",
		},
		edition: "MCPE", // or MCEE
		protocol: 582,
	},
	players: { online: 63234, max: 200000 },
	map_name: "World", // can be undefined
	gamemode: "Survival", // can be undefined
	internal: {
		cached_at: 1673774293240,
		cache_ends_at: 1673774353240,
	},
...
export const queryPart: QueryAnswer = {
	online: true,
	address: {
		host: "185.186.143.239",
		port: 25684,
	},
	motd: {
		raw: "Java MOTD",
	...
	version: {
		...
		brand: {
			raw: "Purpur on 1.19.4-R0.1-SNAPSHOT",
			plain: "Purpur on 1.19.4-R0.1-SNAPSHOT",
			html: "<p>Purpur on 1.19.4-R0.1-SNAPSHOT</p>",
			ansi: "\u001b[0mPurpur on 1.19.4-R0.1-SNAPSHOT\u001b[0m",
		},
		plugins: [
			{
				name: "PlaceholderAPI",
	...
	players: {
		online: 3,
		max: 20,
		names: ["Notch", "Perchun_Pak", "Herobrine"],
	},
	map_name: "world",
	internal: {
		cached_at: 1673774293240,
...
export const offlinePart: OfflineStatusAnswer = {
	online: false,
	address: {
		host: "mc.hypixel.net",
		port: 25565,
	...
	error: {
		short_name: "TimeoutError()",
		traceback:
			'Traceback (most recent call last):\n  File "C:\\Users\\perch\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\asyncio\\tasks.py", line 490, in wait_for\n    return fut.result()\n           ^^^^^^^^^^^^\n  File "C:\\Users\\perch\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\asyncio\\streams.py", line 48, in open_connection\n    transport, _ = await loop.create_connection(\n                   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File "C:\\Users\\perch\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\asyncio\\base_events.py", line 1039, in create_connection\n    infos = await self._ensure_resolved(\n            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File "C:\\Users\\perch\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\asyncio\\base_events.py", line 1413, in _ensure_resolved\n    return await loop.getaddrinfo(host, port, family=family, type=type,\n           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File "C:\\Users\\perch\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\asyncio\\base_events.py", line 867, in getaddrinfo\n    return await self.run_in_executor(\n           ^^^^^^^^^^^^^^^^^^^^^^^^^^^\nasyncio.exceptions.CancelledError\n\nThe above exception was the direct cause of the following exception:\n\nTraceback (most recent call last):\n  File "C:\\Users\\perch\\Desktop\\programming\\mcstatus-web-backend\\mwb\\routes\\versions\\v1\\logic\\get_status.py", line 46, in get_status\n    status = await server.async_status()\n             ^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File "C:\\Users\\perch\\AppData\\Local\\pypoetry\\Cache\\virtualenvs\\mcstatus-web-backend-W73l3y2G-py3.11\\Lib\\site-packages\\mcstatus\\server.py", line 146, in async_status\n    async with TCPAsyncSocketConnection(self.address, self.timeout) as connection:\n  File "C:\\Users\\perch\\AppData\\Local\\pypoetry\\Cache\\virtualenvs\\mcstatus-web-backend-W73l3y2G-py3.11\\Lib\\site-packages\\mcstatus\\protocol\\connection.py", line 612, in __aenter__\n    await self.connect()\n  File "C:\\Users\\perch\\AppData\\Local\\pypoetry\\Cache\\virtualenvs\\mcstatus-web-backend-W73l3y2G-py3.11\\Lib\\site-packages\\mcstatus\\protocol\\connection.py", line 586, in connect\n    self.reader, self.writer = await asyncio.wait_for(conn, timeout=self.timeout)\n                               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File "C:\\Users\\perch\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\asyncio\\tasks.py", line 492, in wait_for\n    raise exceptions.TimeoutError() from exc\nTimeoutError\n',
	},
};
